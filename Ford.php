      ...
      <div class="layout-container flex h-full grow flex-col">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#EEEEEE] px-10 py-3">
          <div class="flex items-center gap-4 text-black">
            <h2 class="text-black text-lg font-bold leading-tight tracking-[-0.015em]">Ford</h2>
          </div>
              ...
              <div class="@container">
                <div class="@[480px]:p-4">
                  <div
                    ...
                    style='background-image: linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://cdn.usegalileo.ai/sdxl10/6c586b5d-eea0-412a-9372-4f0476e7b8ee.png");'
                  >
